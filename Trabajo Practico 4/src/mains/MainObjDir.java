...
public class MainObjDir {

	public static void main(String[] args) {
		// Guia trabajo practico interfaces funcionales con Objeto Definido
		...
		// La referencia al método de un objeto definido no aplica directamente a un
		// Comparator, ya que siempre necesitas comparar dos objetos.
		// 1)Crear un comparador que compare dos personas por altura.
		Comparator<Persona> comparaEstatura = (p1, p2) -> Double.compare(p1.getEstatura(), p2.getEstatura());
